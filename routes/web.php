...
Route::middleware('auth')->group(function () {
    ...
    // Route::get('dashboardps')->name('dashboardps');
    Route::get('terlambatps',[terlambatController::class,'terlambatps'])->name('terlambatps');
    Route::get('siswa',[terlambatController::class,'siswa'])->name('siswa');
    Route::get('/exportps',[terlambatController::class,'exportps'])->name('exportps');
    Route::get('/rekapps',[terlambatController::class,'rekapps']);
